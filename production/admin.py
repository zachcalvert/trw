...
class WorkOrderAdmin(SortableAdminMixin, admin.ModelAdmin):
    form = WorkOrderForm
    list_display = ['__str__', 'active', 'goal', 'stocked', 'published', 'qad', 'stock_date', 'factory', 'priority']
    list_filter = ('factory',)
...
class WorkOrderInline(admin.TabularInline):
    ...
    readonly_fields = ['__str__', 'active', 'goal', 'stocked', 'published', 'qad', 'stock_date', 'factory', 'priority']
